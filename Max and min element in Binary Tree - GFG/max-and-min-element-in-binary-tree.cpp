...
public:
    int findMax(Node *ptr)
    {
        ...
        int a=findMax(ptr->left);
        int b=findMax(ptr->right);
        
        if(ptr->data > max(a,b))return ptr->data;
        else 
         return max(a,b);
    }
    int findMin(Node *ptr)
    {
        ...
        int a=findMin(ptr->left);
        int b=findMin(ptr->right);
        
        if(ptr->data < min(a,b))return ptr->data;
        else 
         return min(a,b);
    }
};
